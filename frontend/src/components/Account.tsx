        ...
        return(
          <div className="mt-3">
            <div className="mt-1 flex mb-2">
              <label className="inline-block mr-2 text-sm font-medium text-gray-900">Amount:</label>
              <input 
        ...
        <div className="flex w-full">
          ...
          <div className="w-2/3 bg-[#D9D9D9] rounded-lg p-3 h-48">
            <div className="flex justify-between rounded-lg bg-[#989898] pt-.5 pb-.5">
              <button 
                className={`px-2 py-1 rounded-md l-0 ${focused === 'Approve' && 'bg-[#7A7A7A]'} text-black font-medium text-sm`}
                onClick={() => focused !== 'Approve' && setFocused('Approve')}>
                Approve
              </button>
              <button 
                className={`px-2 py-1 rounded-md ${focused === 'Deposit' && 'bg-[#7A7A7A]'} text-black font-medium text-sm`}
                onClick={() => focused !== 'Deposit' && setFocused('Deposit')}>
                Deposit
              </button>
              <button 
                className={`px-2 py-1 rounded-md r-0 ${focused === 'Withdraw' && 'bg-[#7A7A7A]'} text-black font-medium text-sm`}
